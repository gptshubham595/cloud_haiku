# Cloud Haiku Welcomes You

Cloud Haiku is an open-source repository that collects haikus about the cloud, cloud technology and publishes these haikus to its website.
